...
{
    $(".nei2").attr("background", "../images/nei2.gif"/*tpa=http://www.chct-bj.com/Content/web/images/nei2.gif*/);
    $("#nei" + id + "").attr("background", "../images/nei2a.gif"/*tpa=http://www.chct-bj.com/Content/web/images/nei2a.gif*/);
}
function CustomParentfrm(height)
{
    $("#FrameMain").attr("height", height)
}
